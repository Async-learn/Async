                ...
                <div>
                    <div className="h-[454px]">
                        ...
                        <motion.img
                            ...
                            className="block md:hidden absolute left-[250px] top-[440px]" src="/htmlmobile.png" alt="html" />
                        <motion.img
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 2.0, duration: 5 }}
                            className="block md:hidden absolute left-[300px] top-[550px]" src="/cssmobile.png" alt="css" />
                        <motion.img
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 3.0, duration: 5 }}
                            className="block md:hidden absolute left-[240px] top-[650px]" src="/jsmobile.png" alt="js" />
                        <motion.img
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 4.0, duration: 5 }}
                            className="block md:hidden absolute left-[79px] top-[650px]" src="/reactmobile.png" alt="react" />
                        <motion.img
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 5.0, duration: 5 }}
                            className="block md:hidden absolute left-[23px] top-[550px]" src="/nodemobile.png" alt="node" />
                        <motion.img
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 6.0, duration:  5 }}
                            className="block md:hidden absolute left-[62px] top-[440px]" src="/pythonmobile.png" alt="python" />
                        {/* desktop */}
                        ...
                        <motion.img 
                            ...
                            className="hidden md:block absolute left-[1200px] top-[200px]" src="/html.png" alt="html" />
                        <motion.img 
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 2.0, duration: 5 }}
                            className="hidden md:block absolute left-[1257px] top-[370px]" src="/css.png" alt="css" />
                        <motion.img 
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 3.0, duration: 5 }}
                            className="hidden md:block absolute left-[1190px] top-[539px]" src="/js.png" alt="javascript" />
                        <motion.img 
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 4.0, duration: 5 }}
                            className="hidden md:block absolute left-[870px] top-[539px]" src="/react.png" alt="react" />
                        <motion.img 
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 5.0, duration: 5 }}
                            className="hidden md:block absolute left-[810px] top-[370px]" src="/node.png" alt="node" />
                        <motion.img 
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 6.0, duration: 5 }}
                            className="hidden md:block absolute left-[850px] top-[200px]" src="/python.png" alt="python" />
                    </div>
                </div>
            </div>
        </div>
